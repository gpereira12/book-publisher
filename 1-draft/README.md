# ✍️ Draft — Projeto 1 (Escrita): O Motor de Criação & Geração do Hub Editorial

Este projeto é responsável por transformar uma ideia ou briefing bruto em um manuscrito completo em **Markdown padronizado** com metadados em **YAML Frontmatter**, pronto para os pipelines de Edit (Projeto 2) e Layout (Projeto 3).
...
python 1-draft/main.py

# Execução direta por arquivo de configuração:
python 1-draft/main.py --config book_config.yaml
```
