# 📝 Edit — Projeto 2 (Revisão): Engine de Qualidade & Lapidação Editorial

Este projeto é o motor de controle de qualidade do **Hub Editorial**. Ele recebe o manuscrito bruto do **Draft (Projeto 1 — Escrita)** e o passa por **5 Módulos de Revisão Editorial** antes de liberá-lo para a diagramação no **Layout (Projeto 3)**.
...
python 2-edit/main.py --book-dir cronicas_chinesas_para_pequenos_guerreiros
```
...
* `inputs/<livro>/texto_revisado.md` — Manuscrito lapidado e pronto para o Layout (Projeto 3).
