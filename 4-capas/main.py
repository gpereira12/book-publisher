...
4-capas/main.py
---------------
Motor do Projeto 4 (Capas & Artes): Sistema Híbrido de Capas.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Projeto 4: Capas & Artes - Motor Híbrido de Capas")
    ...
    print(f"🎨 [Projeto 4] Gerando Capa Gráfica para '{args.book_dir}'...")
    ...
    print(f"✨ [Projeto 4] Capa Horizontal Aberta gerada com sucesso em: {out_pdf}")
